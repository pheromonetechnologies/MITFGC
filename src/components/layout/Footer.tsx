    ...
    <footer className="relative">
      ...
      <div className="relative -mb-1">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
          <path d="M0 60L48 55C96 50 192 40 288 42C384 44 480 58 576 65C672 72 768 72 864 65C960 58 1056 44 1152 40C1248 36 1344 42 1392 45L1440 48V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0V60Z" fill="#002854"/>
        </svg>
      </div>

      <div className="bg-gradient-to-b from-[#002854] to-[#001a3a] text-white pt-12 pb-8 px-6">
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 bg-[#1877F2]/20 hover:bg-[#1877F2] rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1" aria-label="Facebook">
                  <Facebook className="w-4 h-4" />
                </a>
                <a href="#" className="w-10 h-10 bg-[#E4405F]/20 hover:bg-[#E4405F] rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1" aria-label="Instagram">
                  <Instagram className="w-4 h-4" />
                </a>
                <a href="#" className="w-10 h-10 bg-[#FF0000]/20 hover:bg-[#FF0000] rounded-xl flex items-center justify-center transition-all duration-300 hover:-translate-y-1" aria-label="YouTube">
